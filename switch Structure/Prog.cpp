...
int main() {
    ...
    cout << endl << endl;
    cout << setw(7) << setiosflags(ios::left) << "Total" << setw(7) << "A" << setw(7) << "B" << setw(7) << "C"
         << setw(7) << "D" << setw(7) << "F" << endl;
    cout << setw(7) << (ACounter + BCounter + CCounter + DCounter + FCounter) << setw(7) << ACounter << setw(7)
         << BCounter << setw(7) << CCounter << setw(7) << DCounter << setw(7) << FCounter << endl;
